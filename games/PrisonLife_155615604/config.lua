--[[
  Prison Life — defaults merged with getgenv().MYA_PRISON_LIFE_CONFIG or MYA_UNIVERSAL_CONFIG in init.lua.
]]
return {
	-- Independent of team check: skip Inmates for aim / ESP / silent aim when true.
	-- aim_prisoner_check_on = false,
	-- esp_prisoner_check_on = false,
	-- silent_prisoner_check_on = false,
	-- Legacy: pl_skip_inmates = true sets all three when individual keys omitted.
