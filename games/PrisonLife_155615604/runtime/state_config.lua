...
-- Prison Life: optional "Prisoner check" per feature (Inmates team), independent of team check.
local aim_prisoner_check_on = D.aim_prisoner_check_on == true
local esp_prisoner_check_on = D.esp_prisoner_check_on == true
local silent_prisoner_check_on = D.silent_prisoner_check_on == true
if D.pl_skip_inmates == true then
	if D.aim_prisoner_check_on == nil then
		aim_prisoner_check_on = true
	end
	if D.esp_prisoner_check_on == nil then
		esp_prisoner_check_on = true
	end
	if D.silent_prisoner_check_on == nil then
		silent_prisoner_check_on = true
	end
end
...
local car_fly_bv, car_fly_bav, car_fly_conn = nil, nil, nil
